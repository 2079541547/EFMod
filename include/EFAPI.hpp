...
{
private:
    std::map<std::string, void **> variableMap;
    std::map<std::string, void **> functionMap;

    void registerVariable(const std::string &name, void **ptr)
    {
        variableMap[name] = ptr;
    }
...
public:
    ...
    std::map<std::string, void **> get_variableMap()
    {
        Variable();
        return variableMap;
    }

    std::map<std::string, void **> get_functionMap()
    {
        Function();
        return functionMap;
    }
